...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a raised cosine distribution.
*/
declare class RandomStream extends Readable {
	...
	*/
	...
	/**
	* Pseudorandom number generator for generating pseudorandom numbers drawn from a raised cosine distribution.
	*/
...
interface Constructor {
	...
	*/
	...
	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from a raised cosine distribution.
	*
	* @param mu - location parameter
	* @param s - scale parameter
	* @param options - stream options
